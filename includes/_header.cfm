...
<header class="site-header" id="siteHeader">
  <div class="wrap header-inner">
    ...
    <nav class="nav" id="siteNav" aria-label="Main">
      ...
      <a class="nav-link nav-mobile-only" href="/download">Download</a>
    ...
    <div class="header-actions">
      <a class="btn btn-ghost btn-sm js-gh" href="#( application.repo )#" rel="noopener"
         aria-label="RustCFML on GitHub" title="RustCFML on GitHub">
      ...
      <a class="btn btn-primary btn-sm header-dl#( request.section eq 'download' ? ' is-active' : '' )#" href="/download">Download</a>
